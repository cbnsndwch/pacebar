(function () {
  ...
  function safeListDir(ctx, path) {
    if (!ctx.host.fs || typeof ctx.host.fs.listDir !== "function" || !ctx.host.fs.exists(path)) {
      return [];
    }
  ...
  function normalizeQuota(quotaInfo) {
    ...
    var tariff =
      quotaInfo.tariffQuota && typeof quotaInfo.tariffQuota === "object"
        ? quotaInfo.tariffQuota
        : null;
    var topUp =
      quotaInfo.topUpQuota && typeof quotaInfo.topUpQuota === "object"
    ...
    if (maximum === null) {
      ...
      if (tariffMaximum !== null || topUpMaximum !== null) {
        maximum =
          (tariffMaximum !== null ? tariffMaximum : 0) + (topUpMaximum !== null ? topUpMaximum : 0);
      }
    }
    ...
    if (remaining === null) {
      ...
      if (tariffRemaining !== null || topUpRemaining !== null) {
        remaining =
          (tariffRemaining !== null ? tariffRemaining : 0) +
          (topUpRemaining !== null ? topUpRemaining : 0);
      }
    }
  ...
  function probe(ctx) {
    ...
    lines.push(
      ctx.line.text({
        ...
        value:
          scale > 1
            ? formatDecimal(quota.used / scale, 2) +
              " / " +
              formatDecimal(quota.maximum / scale, 2) +
              " credits"
            : String(quota.used),
      }),
    );
    ...
    if (quota.remaining !== null) {
      lines.push(
        ctx.line.text({
          ...
          value:
            scale > 1
              ? formatDecimal(quota.remaining / scale, 2) + " credits"
  ...
  globalThis.__pacebar_plugin = { id: "jetbrains-ai-assistant", probe: probe };
})();
