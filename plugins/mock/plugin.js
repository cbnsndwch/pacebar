(function () {
  ...
  function probe() {
    ...
    return {
      ...
      lines: [
        ...
        lineProgress({
          label: "Time marker empty-side demo",
          used: 20,
          limit: 100,
          format: { kind: "percent" },
          resetsAt: _halfDayReset,
  ...
  globalThis.__pacebar_plugin = { id: "mock", probe };
})();
