...
PaceBar is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch PaceBar from
Spotlight/Launchpad. Persist it, then restart PaceBar.
...
3. Enable the Z.ai plugin in PaceBar settings
