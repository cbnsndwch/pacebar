...
- [**Cloudflare AI (Gateway)**](docs/providers/cloudflare-ai.md) / self-hosted Worker w/ metering, spend, daily burn, windowed token count (1h/24h/7d); gateway URL + key set in settings
