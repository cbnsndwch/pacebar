...
const DARWIN_PATH =
  "~/Library/Application Support/JetBrains/WebStorm2025.3/options/AIAssistantQuotaManager2.xml";
    ...
    ctx.host.fs.writeText(
      ...
      makeQuotaXml({
        ...
        nextRefill: {
          type: "Known",
          next: "2099-01-01T00:00:00Z",
          tariff: { amount: "0", duration: "PT720H" },
        },
      }),
    );
    ...
    ctx.host.fs.writeText(
      ...
      makeQuotaXml({
        ...
        nextRefill: {
          type: "Known",
          next: "2099-01-01T00:00:00Z",
          tariff: { amount: "100", duration: "P30D" },
        },
      }),
    );
    const plugin = await loadPlugin();
    ...
    ctx.host.fs.writeText(
      ...
      makeQuotaXml({
        ...
        nextRefill: {
          type: "Known",
          next: "2099-01-01T00:00:00Z",
          tariff: { amount: "100", duration: "P4W" },
        },
      }),
    );
