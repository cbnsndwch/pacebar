(function () {
  ...
  const VERSION_MANAGER_ROOTS = [
    { root: "~/.nvm/versions/node", modulePath: "/lib/node_modules" },
    {
      ...
      modulePath: "/installation/lib/node_modules",
    },
  ];
  ...
  function buildOauthCandidatePaths(ctx) {
    ...
    paths.push(
      "~/.volta/tools/image/packages/@google/gemini-cli/lib/node_modules" + OAUTH2_SUFFIX_NESTED,
    );
    paths.push(
      "~/.volta/tools/image/packages/@google/gemini-cli/lib/node_modules" + OAUTH2_SUFFIX_FLAT,
    );
