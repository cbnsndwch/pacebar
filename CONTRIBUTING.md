...
- Match the existing design language. PaceBar has a specific look and feel.
...
3. Make your changes
4. Run `pnpm run build` and `pnpm run test` to verify nothing is broken
...
4. Test it locally with `pnpm exec tauri dev`
5. Open a PR with screenshots showing it working

You can also [open an issue](https://github.com/cbnsndwch/pacebar/issues/new?template=new_provider.yml) to request a provider without building it yourself.
...
Don't open a PR for large features without discussing first. [Open an issue](https://github.com/cbnsndwch/pacebar/issues/new?template=feature_request.yml) and make your case.
...
- [@cbnsndwch](https://github.com/cbnsndwch) (lead)

Release tags (`v*`) are owner-managed and can only be created by [@cbnsndwch](https://github.com/cbnsndwch).

## Questions?

Open a [bug report](https://github.com/cbnsndwch/pacebar/issues/new?template=bug_report.yml) or [feature request](https://github.com/cbnsndwch/pacebar/issues/new?template=feature_request.yml) using the issue templates.
